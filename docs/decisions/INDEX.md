...
| [DR-0017](./DR-0017-reply-command.md) | Accepted | `ccmsg reply` (daemon 仲介の返信) + `reply_via` 実行指示 |
...
| [DR-0032](./DR-0032-repo-split-protocol-first.md) | Accepted | リポ分離と規約ファーストの作り直し (daemon / protocol / webui) |
