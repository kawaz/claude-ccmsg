...
| 2026-07-16 | request | open | [composer-panel-drag-desktop](./2026-07-16-composer-panel-drag-desktop.md) | floating composer panel (Room/1on1) をデスクトップ限定 (pointer:fine) でドラッグ移動可能にする (kawaz r26 mid=16+17、viewer 余白 12rem の実機評価後に優先度判断) |
