...
| 2026-07-26 | request | open | [webui-files-search-filter](./2026-07-26-webui-files-search-filter.md) | Files panel にファイル名検索機能を追加 (パス部分一致、複数ワード AND、シンプルな入力 UI)。既存の遅延ロードツリーとの整合が要検討 |
