...
| 2026-08-25 | design | wip | [restart-recovery-last-live-sessions](./2026-08-25-restart-recovery-last-live-sessions.md) | PC 再起動 (daemon ごと落ちる) の後、直前まで「どのディレクトリでどのセッションが動いていたか」が分からなくなる問題。daemon peer スナップショット永続化 + webui 復元導線を検討 |
