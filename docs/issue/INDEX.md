...
|---|---|---|---|---|
| 2026-09-03 | task | open | [webui-auto-reload-on-version-mismatch](./2026-09-03-webui-auto-reload-on-version-mismatch.md) | webui が daemon の version 不一致を検知して自動リロードする。v0.136.0 request_id 必須化で旧 bundle が bad_request 連発になった件の再発防止 |
