...
| 2026-07-10 | design | wip | [subscribe-daemon-restart-transparent-reconnect](./2026-07-10-subscribe-daemon-restart-transparent-reconnect.md) | subscribe の daemon 再起動透過化 (自動再接続) — upgrade のたびに全セッションへ Monitor 張り直し nag が飛ぶノイズの解消 |
