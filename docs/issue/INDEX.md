...
|---|---|---|---|---|
| 2026-09-08 | request | open | [protocol-v2-kv-op](./2026-09-08-protocol-v2-kv-op.md) | v2 に汎用 kv op (kv_read / kv_write / kv_delete + topic kv:<ns>) を追加する。用途は DR-0033 §7 のテーマ永続化 |
