...
| 2026-07-12 | bug | open | [typecheck-excludes-webui-client](./2026-07-12-typecheck-excludes-webui-client.md) | just typecheck が packages/webui/src/client と test を exclude しており、webui クライアントの型エラーが CI で検出されない |
