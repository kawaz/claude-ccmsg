...
| 2026-07-23 | design | open | [session-initiated-1on1-creation](./2026-07-23-session-initiated-1on1-creation.md) | セッション発の対ユーザ報告は TL に誘導する (1on1 自作禁止ガイド)。1on1 はユーザ起点の一方通行専用、セッション側からの room 自作は不採用 |
