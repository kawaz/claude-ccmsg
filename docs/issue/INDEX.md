...
| 2026-07-20 | design | open | [agent-session-tree](./2026-07-20-agent-session-tree.md) | サブエージェント (Agent tool の子) のセッションツリー表示 (kawaz r44 m6-m7)。Status に出ない収集経路の調査、孫まで最大5段の再帰ツリー、TL 隣にセッションツリーパネル新設。コンテキスト不足で未着手中断 |
