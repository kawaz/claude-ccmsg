...
| 2026-07-11 | design | wip | [tailscale-serve-origin-auto-allow](./2026-07-11-tailscale-serve-origin-auto-allow.md) | tailscale serve 構成から ts.net origin を自動許可する zero-config 案 (env 頼みの respawn 再発問題への対策) |
