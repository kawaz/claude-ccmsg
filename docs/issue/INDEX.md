...
| 2026-08-12 | bug | wip | [session-status-snapshot-sync-io](./2026-08-12-session-status-snapshot-sync-io.md) | snapshot() 経路の同期 IO 根治。readAgentTree / discoverWorkspaceFolders が push ごとに readdirSync/readFileSync/statSync を実行 |
