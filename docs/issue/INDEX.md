...
| 2026-07-17 | task | open | [host-translation-followups](./2026-07-17-host-translation-followups.md) | ja(host) 翻訳 + TL 表示のフォローアップ 5 件: ctx 消費表示、thinking 翻訳バッチ化による高速化、全文日本語 skip、select トグル配置変更、teams 要約行表示。simplify workflow 完了後に着手 |
