...
| 2026-07-17 | task | open | [host-translation-followups](./2026-07-17-host-translation-followups.md) | ja(host) 翻訳の webui 側バッチ化 (thinking bundling)。他 4 件は land 済み、残るは複数 thinking の翻訳を 1 リクエストに束ねる集約層の追加 |
...
| 2026-07-21 | design | wip | [session-tree-workflow-tui-parity](./2026-07-21-session-tree-workflow-tui-parity.md) | セッションツリーの webui workflow 表示を TUI 同等にリッチ化: モデル名/tok表示、状態注記、未開始フェーズの淡色表示、ノード選択ドリルダウン。v0.69.0 の AgentTreeGroups 上に構築 |
