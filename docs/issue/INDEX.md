...
| 2026-07-17 | design | open | [thinking-tab-select-toggle](./2026-07-17-thinking-tab-select-toggle.md) | thinking タブの「前選択」ボタンを original タブ限定 + 翻訳選択タブ群と配置分離 + 全選択⇄解除のトグル動作に改善。DR-0023 Phase 2 (webui 配線) と同時実装が自然 |
| 2026-07-17 | design | open | [cli-help-diet-and-reply-rails](./2026-07-17-cli-help-diet-and-reply-rails.md) | ccmsg CLI の `--help` / SKILL.md を基本レール (reply/post/peers/create-room/subscribe/notify) のみに絞り、詳細は `--help-full` へ隠す。1on1 `reply_hint:"tl"` が効きにくい件の対処も検討 |
