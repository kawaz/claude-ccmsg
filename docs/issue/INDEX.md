...
| 2026-08-12 | task | wip | [remaining-sync-io-medium-low](./2026-08-12-remaining-sync-io-medium-low.md) | daemon の残存同期 IO (medium/low) の解消。virtual-sessions 同期スキャン/readAgentToolUseIds/fsEdit等のsync API/realpathSync 等 |
