...
| 2026-07-17 | request | open | [cli-self-exec-latest](./2026-07-17-cli-self-exec-latest.md) | ccmsg CLI が plugin cache のバージョン付き絶対パスで起動された場合、PATH 上の最新 (symlink) と realpath を比較し異なれば exec で譲る self-redirect。daemon の newer-wins upgrade と対になる CLI 側レール |
