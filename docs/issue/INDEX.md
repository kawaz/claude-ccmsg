...
| 2026-07-12 | task | wip | [caddy-origin-allow-persistence](./2026-07-12-caddy-origin-allow-persistence.md) | caddy-app-proxy (Caddy) 経由の webui オリジン許可を daemon respawn 越しに永続化したい |
