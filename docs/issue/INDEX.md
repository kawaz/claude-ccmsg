...
| 2026-08-27 | task | open | [timeline-flatten-second-level-fold-groups](./2026-08-27-timeline-flatten-second-level-fold-groups.md) | TL の fold 構造の簡素化。fold 内の 2 段目グルーピングを廃止し全 item を個別行表示に |
