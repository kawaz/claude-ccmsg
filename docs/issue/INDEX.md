...
|---|---|---|---|---|
| 2026-09-15 | bug | wip | [room-member-cwd-takes-bash-temporary-cwd](./2026-09-15-room-member-cwd-takes-bash-temporary-cwd.md) | room の member 情報の `cwd` が直前の Bash ツールの一時 cwd を拾う (v2 は 46f7ba40 で修正済み、v1 のここはこれから) |
