...
|---|---|---|---|---|
| 2026-09-15 | bug | resolved | [room-member-cwd-takes-bash-temporary-cwd](./2026-09-15-room-member-cwd-takes-bash-temporary-cwd.md) | room の member 情報の `cwd` が直前の Bash ツールの一時 cwd を拾う (788ad1ea で修正、本番 daemon 入れ替え後の再現確認待ち) |
