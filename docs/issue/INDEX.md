...
|---|---|---|---|---|
| 2026-09-03 | request | open | [cache-keepalive-webhook-injection](./2026-09-03-cache-keepalive-webhook-injection.md) | llm-gateway の cache_keepalive webhook を受けてセッションにマーカーを注入する (DR-0024 §2) |
| 2026-09-03 | task | open | [fold-two-phase-ops-into-rpc](./2026-09-03-fold-two-phase-ops-into-rpc.md) | v0.136.0 の request_id 応答相関で 2-phase op の型が不要に。await 1 応答形へ畳み acceptTwoPhase / result イベントを撤去 |
