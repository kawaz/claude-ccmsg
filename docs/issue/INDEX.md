...
| 2026-07-23 | request | blocked | [hyoui-fab-avoid-position-param](./2026-07-23-hyoui-fab-avoid-position-param.md) | Terminal iframe に hyoui fab の回避位置パラメータを追加。hyoui 側の仕様確定待ち (r53 を watch) |
| 2026-07-23 | request | open | [tl-agent-message-rich-unify](./2026-07-23-tl-agent-message-rich-unify.md) | TL のエージェント間メッセージ表示 (AgentCard/SendMessage/peer-message) を ROOM チャットの rich 表示 (アイコン+名前+identicon hue) に統一する |
