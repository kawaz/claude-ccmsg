...
| 2026-07-23 | design | open | [filepath-linkify-phase-bc](./2026-07-23-filepath-linkify-phase-bc.md) | filepath リンク化 Phase B/C: daemon 経由の存在確認 (fs_stat_batch) + external files (DR-0024) 経路 + client キャッシュ。batch 粒度/cache invalidation/fold 内先読みの扱いが未裁定 |
