...
| 2026-07-15 | bug | wip | [subscribe-reconnect-nonmsg-redelivery](./2026-07-15-subscribe-reconnect-nonmsg-redelivery.md) | subscribe 再接続時、mid ベース since cursor が msg 専用のため archive/title/kind/next/prev が重複再配信されうる (kuu からの部外者フィードバック、コード裏取り済み) |
