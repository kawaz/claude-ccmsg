...
| 2026-07-31 | bug | wip | [path-canonicalization-latent-gaps](./2026-07-31-path-canonicalization-latent-gaps.md) | パス正規化の潜在ギャップ 2 件: symlink 綴りの containment 判定漏れ、peers.cwd が生綴りのまま非対称になっている件 |
