...
| 2026-07-16 | design | open | [fs-write-inbox-root-mismatch](./2026-07-16-fs-write-inbox-root-mismatch.md) | fs_write の containment root が repo_root ?? cwd 固定で jj workspace 運用と噛み合わず、inbox メモがどの working copy にも属さない場所に落ちる (write policy 境界拡張は kawaz 裁定要) |
