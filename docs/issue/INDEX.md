...
| 2026-08-12 | bug | open | [tl-search-scope-fold-granularity](./2026-08-12-tl-search-scope-fold-granularity.md) | 📁 OFF の [N/M] が thinking/items 単体の details 開閉を拾わない (foldRevision が fold group 単位で単体 toggle を拾っていない) |
