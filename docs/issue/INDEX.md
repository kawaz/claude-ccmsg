...
| 2026-07-10 | design | wip | [webui-transport-trust-model-security-critical](./2026-07-10-webui-transport-trust-model-security-critical.md) | **Critical**: HTTP/WS trust model 見直し (Origin 検証 + 127.0.0.1 bind 回帰 + tailnet allow 削除)、悪意 Web ページからの DoS/情報漏洩/偽メッセージ注入を防ぐ |
| 2026-07-10 | design | wip | [storage-append-atomicity](./2026-07-10-storage-append-atomicity.md) | storage.ts appendEvent の in-memory 更新が disk 書き込みより先行、write 失敗時に状態分岐 (codex レビュー Major 4 起票) |
| 2026-07-10 | design | wip | [codex-review-nitpick-cleanup](./2026-07-10-codex-review-nitpick-cleanup.md) | codex レビュー Minor 指摘 3 件まとめ (webui pending flush 漏れ / ln quoting / DR-0002 crash-loop 仕様乖離) |
