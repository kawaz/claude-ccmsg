...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-21T03:23:13+09:00
discard_reason:
pending_reason:
close_reason: ["done: 実装済みを確認 (v0.68.2 時点でランド済み、issue close 漏れ)。Sidebar.tsx の RoomCreatorToggleButton + RoomCreator.tsx (タイトル/kind ラジオ/broadcast 時メンバー欄非表示/作成成功で room へ遷移)。受け入れ条件 7 項目充足、webui テスト 826 pass"]
blocked_by:
origin: 自リポ TODO
---
