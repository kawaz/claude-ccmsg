...
pending_entered:
discarded_entered:
resolved_entered: 2026-07-22T17:05:57+09:00
discard_reason:
pending_reason:
close_reason: ["prefilterを一重/二重エスケープ両綴りのany-matchに拡張して修正 (commit fd01d3eb)","タブ/バックスラッシュを含むccmsg payloadのliteralヒットをテストで固定 (daemon 644 pass)"]
blocked_by:
origin: 自リポ TODO
---
