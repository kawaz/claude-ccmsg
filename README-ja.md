...
**MVP 実装済み。** アーキテクチャは [DR-0001](./docs/decisions/DR-0001-central-daemon-architecture.md) / [DR-0002](./docs/decisions/DR-0002-daemon-supervision.md) / [DR-0003](./docs/decisions/DR-0003-wire-protocol.md) (いずれも Accepted) に記録し、その根拠は [docs/research/](./docs/research/) の逐語一次資料に置いてある。daemon / CLI / protocol は `packages/` 配下に実装・テスト済み。web UI は後 phase (未着手)。
